# 🤖📸 Fortuna Reads the Charts
### AI-Powered Chart Analysis with Christopher Wilson
*Fortuna — Wealth Warden | Feb 22, 2026*

---

> 💡 **New here? Start with the findings below** — real
> analysis from today's session. Then scroll to
> [How This Works](#-how-fortuna-reads-a-screenshot)
> to see the full workflow. The color system reference
> lives at the bottom.
...
distinction. FCR is a 9:35 NY strategy. The ETH
...
and frequently revisits them, especially at the
...
5min candle at a structural level after the
9:35 NY open. Price must hold above this ray
for the long thesis to remain valid.
...
The mirror of the above. Low of the first 5min
candle at a structural level — the primary short
setup. As Feb 13th showed: one clean trade from
this level is a complete trade. The level doesn't
owe you a second entry.
