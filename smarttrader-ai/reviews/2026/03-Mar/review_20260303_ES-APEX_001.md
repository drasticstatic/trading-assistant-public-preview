...
1. **Red dominant = no counter-trend longs. No exceptions.** If EMAs are red dominant, the IT Foundation gate is closed for longs — regardless of eval pressure, time of day, or how compelling the setup looks.
2. **Wait for 9:45.** No entries before the FCR first candle closes. The scenario is undefined before then.
3. **Eval pressure is a behavioral risk, not a trading input.** The premarket brief identified it. The antidote is naming it in the moment and pausing before acting.
