# 🔍 Trade Review — CL Long · APEX-05 · Tue, Mar 3, 2026
### 20260303_CL-APEX_003 · -$460.00 · SL respected · AutoLiq on account blow
...
1. **CL SL is non-negotiable — full stop.** CL's structural volatility means a 2–3 point move against can happen before a recovery even begins. The SL is not a suggestion; it is the only thing standing between a contained loss and account destruction. Place it. Leave it.
2. **One instrument at a time near the eval floor.** Two simultaneous positions on a near-breach account leaves zero equity buffer when one trade moves against. On APEX-06 and TPT: when near the trailing drawdown floor, one trade, one instrument, full risk management.
3. **Process-correct entries can still lose — that is not a reason to adjust.** The CL setup was sound. The exit was outside the trade's control. The discipline to not cancel the SL (even accidentally) is the lesson to carry forward.
