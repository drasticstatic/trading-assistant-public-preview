# 🔁 Pattern Tracker — Progress Log
### STB SmartTraderAI | Fortuna | Recovery Arc → Live Performance
*Appended after each session. Full reviews linked per entry.*
*For coaches: this file is the single-source progress view across all sessions.*
...
| 20260730_MCL-APEX8_001 | Jul 30 | MCL | Short | 85.22 | 83.94 | **+$256.00** | — | — | — | ⏳ Pending journal data | — | — |
| 20260730_MCL-APEX8_002 | Jul 30 | MCL | Short | 84.81 | 83.94 | **+$174.00** | — | — | — | ⏳ Pending journal data | — | — |
| 20260903_MGC-TOF288_001 | Sep 3 | MGC | Short | 4,524.80 | 4,520.80 | **+$80.00** | — | — | — | ⏳ Pending journal data | — | — |
| 20260903_MGC-TOF292_001 | Sep 3 | MGC | Short | 4,524.80 | 4,520.80 | **+$80.00** | — | — | — | ⏳ Pending journal data | — | — |
| 20260903_MGC-APEX11_001 | Sep 3 | MGC | Short | 4,524.80 | 4,520.80 | **+$80.00** | — | — | — | ⏳ Pending journal data | — | — |
...
|------|------------------|--------------------|---------------------|--------------|---------------------|
| Feb 13 | Ego, denial | ❌ | ❌ | ❌ Stops moved | Rules abandoned under pressure |
| Feb 23 | Excited, anxious | ❌ | ⚠️ Partial (FOMO, B-grade) | ✅ | FOMO → B-grade entry level |
...
|------|-------------|----------|-----|-----|-----------|-----------|-------|
| Feb 23 | ✅ Scenario A | ✅ Red dom | ⚠️ 3/5 (mitigated) | ✅ | — | 3/4 | B |
...
|------|-----------|----------|--------------|-------|
| Feb 23 | MNQ | 12 min 50 sec | SL hit | Correct SL respect |
...
|------|------------|-------------|---------|
| Feb 23 | STB + ZTH | 9:30 AM open session | SL not at 5/5 buffer — swept |
...
```
Trigger:    Correct directional read → impatience → B-grade level entry
Symptom:    Filled at 3/5 (mitigated) instead of 5/5 (active)
            SL placed AT the 5/5 → swept by 1 tick
Result:     Stop hit on a correct trade → full TP reached after
Fix:        FVG must align with 5/5 (active) for A+ grade
Status:     ✅ Fixed on Feb 25 (5-layer confluence, 5/5 alignment)
```

### Pattern 2 — Wrong Scenario (Feb 24)
```
Trigger:    Anxiety + greedy → counter-trend long on bearish day
Symptom:    EMAs steeply red dominant = explicit Scenario B veto
            Entered anyway → 66 seconds → full SL
Fix:        IT Foundation EMA gate: red dominant = no counter-trend long. Period.
Status:     ✅ Fixed on Feb 25 (EMAs green dominant = Scenario B valid)
```

### Pattern 3 — Coach-Lag (Feb 24)
```
Trigger:    Following STB/ZTH entries late at the open → wrong timing
Symptom:    Entry in wrong direction after coach trigger = bad fill
Fix:        Pre-market preparation → independent entry → coaches for confluence
Status:     ✅ Reversed on Feb 25 (in trade before ZTH's 25,348 level reached)
```

### Pattern 4 — Stop Movement (Feb 13)
```
...
Feb 13  ██████████░░░░░░░░░░  BLOWUP — stops moved, accounts blown
                               ↓ Rule: SL placed and never moved
Feb 23  ██████████████░░░░░░  SL held. Direction correct. Level = B-grade.
                               ↓ Rule: 5/5 only, or skip
Feb 24  ██████████████░░░░░░  SL held. Wrong scenario. EMA gate ignored.
...
- [Mar 3 — ES Long T1](../../smarttrader-ai/reviews/2026/03-Mar/review_20260303_ES-APEX_001.md)
- [Mar 3 — ES Short T2 (AutoLiq)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260303_ES-APEX_002.md)
- [Mar 3 — CL Long T3 (AutoLiq)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260303_CL-APEX_003.md)
- [Mar 10 — MNQ Long T1 (-$108)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260310_MNQ-APEX_001.md)
- [Mar 12 — SOL Short](../../smarttrader-ai/reviews/2026/03-Mar/review_20260312_SOLUSDT-BTCC_001.md)
- [Mar 16 — MNQ Short T1 (-$268.50)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260316_MNQ-APEX_001.md)
- [Mar 16 — RTY Short T2 (+$935)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260316_RTY-APEX_002.md)
- [Mar 17–18 — MNQ Short overnight (+$963)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260317_MNQ-APEX_001.md)
- [Mar 20 — RTY Long (+$525 · unintentional fill)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260320_RTY-APEX_001.md)
- [Mar 24 — ES Short overnight (+$1,225 · APEX-06)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260324_ES-APEX_001.md)
- [Mar 25–26 — SOL/USDT Long (-$14.13 · BTCC voucher)](../../smarttrader-ai/reviews/2026/03-Mar/review_20260325_SOLUSDT-BTCC_001.md)
